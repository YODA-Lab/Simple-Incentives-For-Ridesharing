...
if __name__ == '__main__':
    ...
    travel_times = travel_times.astype('float64')
    ...
    # Train
    model.fit(x=X_train, y=y_train, validation_data=(X_valid, y_valid), batch_size=1024, epochs=1000, callbacks=[EarlyStopping(patience=15), ModelCheckpoint('../../models/embedding_ny.h5', save_best_only=True)])
